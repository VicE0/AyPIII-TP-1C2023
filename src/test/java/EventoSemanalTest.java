...
//
//        assertEquals(primerEventoEnLista.toLocalDate(), eventoSemanal.obtenerFechaInicio().toLocalDate());
//        assertEquals(segundoEventoEnLista.toLocalDate(), eventoSemanal.obtenerFechaFin().toLocalDate());
//
