...
//        var eventoMensual = new EventoMensual();
//
//        List<LocalDateTime> proximosEventos = eventoMensual.obtenerProximosEventos();
//
//        LocalDateTime primerEventoEnLista = proximosEventos.get(0);
//        LocalDateTime segundoEventoEnLista = proximosEventos.get(1);
//
//        assertEquals(primerEventoEnLista.toLocalDate(), eventoMensual.obtenerFechaInicio().toLocalDate());
//        assertEquals(segundoEventoEnLista.toLocalDate(), eventoMensual.obtenerFechaInicio().toLocalDate().plusMonths(1));
//
